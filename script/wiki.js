...
if(rechercheencart0.length>0){ClaraIASpeech(rechercheencart0);return}				
if(rechercheencart3.length>0){ClaraIASpeech(rechercheencart3);return}
if(rechercheencart5.length>0){ClaraIASpeech(rechercheencart5);return}
ClaraIASpeech("désolé je n'ai rien trouvé")
		//	}//fin else
		//}//fin esle

})//fin requestclarawsrnodejs
