...
openssl req -x509 -newkey rsa:2048 -keyout key.pem -out cert.pem -days 3650 -nodes -subj "/C=FR/ST=jarvispage/L=jarvispage/O=jarvispage/OU=jarvispage/CN=127.0.0.1"
del .rnd
