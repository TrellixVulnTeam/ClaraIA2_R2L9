...
for( var i=0 ; i< contents.length; i++){
       ...
       var time=contents[i]
            ...
            function timer(contentsspeak,difference,time){ 
              ...
              setTimeout(function(){
if(contentsspeak.search('Clara')<0){
...
request({ uri : 'https://127.0.0.1:4300/clara?reco='+contentsspeak }, function (err, response, body){console.log('err=rr'+err+response)})
}
              }, difference);
            } 
